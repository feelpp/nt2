...
/*
NT2_TEST_CASE_TPL( container_concept_conformance, NT2_TYPES )
{
  using nt2::settings;
...
// difference_type   signed integer            must be the same as iterator_traits::difference_type
// size_type         unsigned integer          large enough to represent all positive values of difference_type

  // NT2_TEST_TYPE_IS( typename container<some_kind_, T, settings()> >::value_type
  //                 , T
  //                 );

  // NT2_TEST_TYPE_IS( typename container<some_kind_, T, settings()> >::reference
  //                 , T&
  //                 );

  // NT2_TEST_TYPE_IS( typename container<some_kind_, T, settings()> >::const_reference
  //                 , const T&
  //                 );

  // NT2_TEST_TYPE_IS( typename container<some_kind_, T, settings()> >::difference_type
  //                 , const T&
  //                 );

  // NT2_TEST_TYPE_IS( typename container<some_kind_, T, settings()> >::size_type
  //                 , const T&
  //                 );
}
*/
...
NT2_TEST_CASE( foo )
{
  ...
  container<some_kind_, double, settings()> c;
